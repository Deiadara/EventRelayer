...
async function build_and_deploy(provider,wallet,contract_name) {
...
async function main() {
    ...
    build_and_deploy(src_provider,src_wallet,"Deposit")
    build_and_deploy(dst_provider,dst_wallet,"Token")
}
